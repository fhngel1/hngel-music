...
const youtube = new YouTube('AIzaSyDmev9rsVHvH1uD_VwiulDrkjP-shFjPOo');
const hastebins = require('hastebin-gen');
const getYoutubeID = require('get-youtube-id');
const yt_api_key = "AIzaSyDmev9rsVHvH1uD_VwiulDrkjP-shFjPOo";
...
let g = client.guilds.get("625516765610246163"); // id server
let c = g.channels.get("625517385570582550");// id channel
if(c.type === 'voice') {
c.join();
setInterval(() => {
...
client.on('ready', () => {
    ...
    client.user.setActivity(`Type ${prefix}help`,{type: 'Watching'}); ///التعديل علي البلاينج
});
...
أمر بداية البوت : ${prefix}

> Play [p] : تشغيل أُغنية او اضافتها للقائمة
> Pause : ايقاف مؤقت الاغنية
> Ping : عرض استجاب البوت
> Resume : استكمال الأغنية
> Repeat [re] : تكرار الاغنية الحالة
